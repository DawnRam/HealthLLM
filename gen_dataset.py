...
if MODE == "train":
    if DATA == "LifeSnaps":
        ...
        DATA_PATH = "/home/cyang/Data/Healthcare/lifesnapes"
            ...
            for idx,row in enumerate(csv_reader):
                ...
                try:
                    ...
                    if SUBTASK == "activity":
                        ...
                        Q = "The recent sensor readings show: [Steps]: {:.2f} steps, [Burned Calorries]: {:.2f} calories, [Heart Rate]: {:.2f} beats/min; What would be the predicted activity type?".format(steps, calories, heart_rate)
        ...
        for dir1 in tqdm(os.listdir(DATA_PATH)):
            ...
            if '.' not in dir1:      
                ...
                for d,f,m,r,sd,sq,s in zip(date, fatigue, mood, readiness, sleep_dur, sleep_qual, stress):
                    ...
                    Q = "The recent 14-days sensor readings show: [Steps]: {} steps, [Burned Calorries]: {} calories, [Resting Heart Rate]: {} beats/min, [SleepMinutes]: {} minutes, [Mood]: {} out of 5; What would be the predicted {}?".format([x[-1] for x in exercise_hist], [x[-2] for x in exercise_hist], [x[-1] for x in hr_hist], [x[-1] for x in sleep_hist], m, SUBTASK)
        ...
        for insw_idx in tqdm([1,2,3,4]):
            data1 = csv_reader('/home/cyang/Data/Healthcare/globem/INS-W_{}/SurveyData/dep_weekly.csv'.format(insw_idx))
            dict1 = {}
            keys1 = []
            ...
            data2 = csv_reader('/home/cyang/Data/Healthcare/globem/INS-W_{}/FeatureData/steps.csv'.format(insw_idx))
            dict2 = {}
            keys2 = []
            ...
            data3 = csv_reader('/home/cyang/Data/Healthcare/globem/INS-W_{}/FeatureData/sleep.csv'.format(insw_idx))
            dict3 = {}
            keys3 = []
    ...
    # Split the data
    final_eval_data = final_data[:val_size]
    final_train_data = final_data[val_size:]

    # 3-shot, 10-shot, 25-shot
    ...
    # Save validation set to val.json
    with open("{}_{}_val.json".format(DATA, SUBTASK), "w") as outfile_val:
        outfile_val.write(json_object_eval)
